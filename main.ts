...
controller.menu.onEvent(ControllerButtonEvent.Pressed, function () {
    mySprite2 = sprites.create(assets.image`menu`, SpriteKind.Menu)
})
...
game.showLongText("Use the left and right button to move, hit A to interact, and hit B to run! Press Menu to access the menu!", DialogLayout.Bottom)
mySprite.destroy()
mySprite = sprites.create(img`
    . . . . . . f f f f f f . . . . 
    . . . . f f e e e e f 2 f . . . 
...
game.onUpdate(function () {
    plant_enemy1 = sprites.create(img`
        . . . . . . . . 
        . . . . . . . . 
        . . . . . . . . 
        . . . . . . . . 
